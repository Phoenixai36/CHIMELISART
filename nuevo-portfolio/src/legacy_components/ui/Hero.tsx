...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full min-h-screen overflow-hidden bg-black ${className}`}>
      ...
      <canvas
        ref={canvasRef}
        className="absolute inset-0 w-full h-full object-contain touch-none bg-black pointer-events-none md:pointer-events-auto"
      />
        ...
        <div className="container text-center space-y-6">
          ...
          <div className="space-y-1 md:space-y-2 w-full">
            <div className="overflow-visible">
              <h1 className="text-[6.2vw] sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-[-0.08em] leading-none bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent animate-fade-in-up animation-delay-200">
                {headline.line1}
              </h1>
            </div>
            <div className="overflow-visible">
              <h1 className="text-[2.8vw] sm:text-xl md:text-3xl lg:text-4xl font-light tracking-normal leading-tight bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent animate-fade-in-up animation-delay-400">
                {headline.line2}
              </h1>
            </div>
          </div>
          ...
          <div className="max-w-3xl mx-auto animate-fade-in-up animation-delay-600">
            <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-orange-100/90 font-light leading-relaxed">
              {subtitle}
            </div>
          </div>
